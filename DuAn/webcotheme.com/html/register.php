...
<!-- Mirrored from webcotheme.com/html/streetwear/stw004/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Nov 2021 02:36:34 GMT -->
<head>
<!-- Basic Page Needs
  ================================================== -->
<meta charset="utf-8">
<title>Streetwear Register</title>
<!-- SEO Meta
  ================================================== -->
                ...
                <div class="row">
                  <div class="col-xs-12 mb-20">
                    <div class="heading-part heading-bg">
                      <h2 class="heading">Tạo tài khoản khách hàng</h2>
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <div class="input-box">
                  ...
                  <div class="col-xs-12">
                    <div class="input-box">
                      ...
                      <input id="login-pass" type="password" required="" placeholder="Mật khẩu của bạn">
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <div class="input-box">
                      <label for="re-enter-pass">Nhập lại mật khẩu</label>
                      <input id="re-enter-pass" type="password" required="" placeholder="">
                    </div>
                  </div>
                  <div class="col-xs-12">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="new-account align-center mt-20">
                      ...
                      <a class="link" title="Register with Streetwear" href="login.html">Đăng nhập tại đây</a>
                    </div>
                  </div>
                </div>
              </form>
