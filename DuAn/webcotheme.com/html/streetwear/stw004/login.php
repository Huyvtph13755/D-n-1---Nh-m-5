...
<!-- Mirrored from webcotheme.com/html/streetwear/stw004/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Nov 2021 02:35:27 GMT -->

<head>
  <!-- Basic Page Needs
  ================================================== -->
  <meta charset="utf-8">
  <title>Streetwear Login</title>
  <!-- SEO Meta
  ================================================== -->
                    ...
                    <li class="content">
                      ...
                      <div class="content-dropdown">
                        <ul>
                          ...
                          <li class="account-icon"><a href="account.html" title="My Account"><span></span>My Account</a>
                          </li>
                              ...
                              <div class="media-body">
                                ...
                                <div class="product-qty">
                                  <div class="custom-qty">
                                    <input type="text" name="qty" maxlength="8" value="1" title="Qty"
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12">
                      <div class="new-account align-center mt-20">
                        ...
                        <a class="link" title="Register with Streetwear" href="register.html">Create New Account</a>
                      </div>
                    </div>
                  </div>
                </form>
