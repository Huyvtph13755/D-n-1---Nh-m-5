      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="heading-part align-center mb-40">
            <h2 class="main_title">What are you looking for today ?</h2>
          </div>
        </div>
        <div class="col-md-12 col-md-offset-2 col-sm-12 col-sm-offset-0">
            ...
            <a> <img src="./View/images/sub-banner1.jpg" alt="Streetwear">
              <div class="sub-banner-detail">
                ...
                <div class="sub-banner-subtitle">
                  <span>5.0" IPS LCD Touchscreen,</span>
                  <span>16MP camera,</span>
                  <span>Wi-Fi, GPS, Bluetooth</span>
                </div>
              </div>
            </a> 
          </div>
